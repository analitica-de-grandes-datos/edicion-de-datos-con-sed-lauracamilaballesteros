...
#sed -E 's|([0-9]{2})/([0-9]{2})/([0-9]{2})|\3-\2-\1|g ; s|([0-9]{1})/([0-9]{1})/(20[0-9]{2})|\3-0\2-0\1|' data.csv > output.csv

#sed -E 's|([0-9]{2})/([0-9]{2})/([0-9]{2})|20\3-\2-\1|g ; s|([0-9]{1})/([0-9]{1})/(20[0-9]{2})|\3-0\2-0\1|; s/[a-z]/\U&/g' data.csv > output.csv

#sed -E 's|([0-9]{2})/([0-9]{2})/([0-9]{2})|20\3-\2-\1|g ; s|([0-9]{1})/([0-9]{1})/(20[0-9]{2})|\3-0\2-0\1|; s/[a-z]/\U&/g; s|,|.|g; s|;|,|g;

#sed -E 's|([0-9]{2})/([0-9]{2})/([0-9]{2})|20\3-\2-\1|g ; s|([0-9]{1})/([0-9]{1})/(20[0-9]{2})|\3-0\2-0\1|; s|[a-z]|\U&|g; s|,|.|g; s|;|,|g; s|,,|,\N,|g; s|,N,|,\\N,|g; s|,$|,\\N|g; s|,N|,\\N,|g'  data.csv > output.csv


sed -E 's|([0-9]{2})/([0-9]{2})/([0-9]{2})|20\3-\2-\1|g ; s|([0-9]{1})/([0-9]{1})/(20[0-9]{2})|\3-0\2-0\1|; s|[a-z]|\U&|g; s|,|.|g; s|;|,|g; s|,,|,\N,|g; s|,N,|,\\N,|g; s|,N|,\\N,|g;  s/,$/&\N/g'  data.csv > output.csv